<h1 align="center">NodeJS + EJS</h1>
<p align="center">Project to make a web page with NodeJS and EJS.</p>
...
- This project was made to practice the  creation of a HTML page using EJS. In this project I use the most used tools in EJS to create a web page organized in a way that is scalable and in a way that is easy to maintain. 
